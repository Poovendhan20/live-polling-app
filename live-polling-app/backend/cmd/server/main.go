...
func main() {
	...
	routes.Register(r, &handlers.AuthHandler{Service: auth}, &handlers.PollHandler{Service: poll, Votes: vote}, &handlers.VoteHandler{Polls: poll, Votes: vote}, &handlers.WSHandler{Hub: ws.NewHub(clients.Redis)}, cfg.JWTSecret)

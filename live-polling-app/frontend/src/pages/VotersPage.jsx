...
export default function VotersPage() {
  ...
  useEffect(() => { getPollVoters(id).then((response) => setData(response.data)).catch(() => setError('You do not have access to this voter list.')); }, [id]);
